...
In Claude Code, run `ettrace` in a TTY-capable shell session and answer any prompts interactively. Without a TTY, the runner can exit without a useful trace.
